use std::collect::{HashMap, HashSet};

const MONTH2DAYS: [u32; 13] = [0, 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
...
fn date_to_week_count(year: u32, month: u32, day: u32) -> u32 {
    let week_day = date_to_week_day(year, 1, 1);
...
fn date_to_trading_days(year: u32, month: u32, day: u32) -> u32 {
    // let mut date2holiday: HashSet<(u32, u32)> = HashSet::new();
    // date2holiday.insert((10, 1));
    // date2holiday.insert((10, 2));
    // date2holiday.insert((10, 3));
    // date2holiday.insert((10, 4));
    // date2holiday.insert((10, 5));
    // date2holiday.insert((10, 6));
    // date2holiday.insert((10, 7));

    // if date2holiday.contains(&(month, day)) {
    //     return 0;
    // }
